...
In order to successfully perform a data mining project, it is important to ask direct and specific questions to be address, rather than broad or open ended ones.  The focus of this data mining activity be framed as `predict whether an acquisition is likely to succeed or fail, and how long will the process is likely to take'.

This project shall be conducted using the CRISPDM methodology. The methodolgy looks to build rich data mining projects
