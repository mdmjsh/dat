...
We can now evaluate whether the models selected were appropriate in general. Was DT over simplistic and could it be improved with a random forest algorithm? Perhaps CrunchView have decided they are interested in the probability of an acquisition completing (i.e no longer a binary classification), in this instance we would restart the cycle, addressing structural questions of the data (e.g. is it acylic) to define what probablistic models can be applied.
